...
<title>Member Details of St. Stephen's Jacobite Syriac Orthodox Church, San Jose, California</title>
...
<div class="page-top">
	...
	<div class="container"> 
		...
		<ul>
			<li><a href="directory.php?page=<?php echo $pageno;?>" title="">Back</a></li>
		</ul>
	</div>
</div><!--- PAGE TOP -->
<section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 column">
					...
					<?php
						...
						if(!file_exists($imageUrl)){
							$imageUrl= "cmsapp/images/user/".strtolower($userAccountObj->getGender()).".jpg";
						}
						?>
						...
						<div class="team-detail">
							...
							<ul class="team-list">
								...
								<li><i class="fa fa-venus-mars custom" style="font-size:24px"></i> <?php echo $userAccountObj->getGender();?> </li>
								<li><i class="fa fa-birthday-cake" style="font-size:24px"></i> <?php echo dateDisplayFormat($userAccountObj->getDob(),"F d");?></li>
								<li><i class="fa <?php echo ($userAccountObj->getMaritalStatus()=="Married")?"fa-handshake-o":"fa-user-circle";?>" style="font-size:24px"></i> <?php echo$userAccountObj->getMaritalStatus();?>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<?php if($userAccountObj->getMaritalStatus()=="Married"){ 	?>
								<i class="fa fa-heart-o" style="font-size:24px"></i> 
								<?php echo$userAccountObj->getSpouseName();
								 } ?>
								</li>
				...
				<aside class="col-md-4 sidebar column">
					<div class="widget">
						<div class="widget-title"><h4>About me</h4></div>
						<p><?php echo $userAccountObj->getAboutme();?></p>		
						<div class="space"></div>					
						<div class="widget-title"><h4>About Family</h4></div>
						<p><?php echo $userAccountObj->getAboutFamily();?></p>
					</div><!-- GALLERY -->
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$membersArray=$userServiceObj-> getMembers($regUId); 
									...
									<tr>
										...
										<td><?php echo dateDisplayFormat($memberObj->getDob(),"M d"); ?></td>
