...
<title>Gospel Messages of St. Stephen's Jacobite Syriac Orthodox Church, San Jose, California</title>
	...
	<div class="block remove-gap">
		<div class="container">
			<div class="row">
				<div class="title2">
					<span></span>
					<h2><span>GOSPEL MESSAGES</span></h2>
				</div>
								...
								<div class="col-md-4">
									<div class="gallery">
										<div class="embed-responsive embed-responsive-1by1">
											<iframe  style="height: 30vh;"  class="embed-responsive-item" 
					src="http://www.youtube.com/embed/jy8OANuctUM?rel=0&feature=player_detailpage&wmode=transparent" frameborder="0" allowfullscreen>
											</iframe>
										</div>							
									</div><!-- GALLERY ITEM -->
								</div>
								<div class="col-md-4">
									<div class="gallery">
										<div class="embed-responsive embed-responsive-1by1">
											<iframe  style="height: 30vh;"  class="embed-responsive-item" 
							src="http://www.youtube.com/embed/x9_p2qIJjSs?rel=0&feature=player_detailpage&wmode=transparent" frameborder="0" allowfullscreen>
											</iframe>
										</div>								
									</div><!-- GALLERY ITEM -->
								</div>
								<div class="col-md-4">
									<div class="gallery">
										<div class="embed-responsive embed-responsive-4by3">
											<iframe style="height: 30vh;"  class="embed-responsive-item" 
											src="http://www.youtube.com/embed/1w--sXOvVm4?rel=0&feature=player_detailpage&wmode=transparent" frameborder="0" allowfullscreen>
											</iframe>
										</div>								
									</div><!-- GALLERY ITEM -->
								</div>	
