                                ...
                                <form action="edituser_action.php" method="POST" enctype="multipart/form-data">
                                    <div class="box-body">   
										...
										<div class="form-group">
											...
											<input type="hidden" name="uid" id="uid" value="<?php echo $userAccount->getUId();?>"/>
											<input type="text" placeholder="Name" value="<?php echo $userAccount->getFirstName();?>" required name="Name" id="Name" class="form-control" />
	 
										</div>
										<div class="form-group">
											<label for="LocalAdr1">UserName </label><p><?php echo showMessage('adduserError') ;?></p>
											<input type="email" readonly  placeholder="Enter email Id" value="<?php echo $userAccount->getUserId();?>" required name="UserId" id="UserId" class="form-control" />
											<input type="hidden" name="emailid" id="emailid" value="<?php echo $userAccount->getUserId();?>"/>
										</div>											
										<div class="form-group">
											<label for="LocalAdr1">Place </label><p><?php echo showMessage('adduserError') ;?></p>
											<input type="text"  placeholder="Enter Place" value="<?php echo $userAccount->getCity();?>" required name="Place" id="Place" class="form-control" />
										</div>	
										<div class="form-group">
											<label for="LocalAdr1">Mobile </label><p><?php echo showMessage('adduserError') ;?></p>
											<input type="text"  placeholder="Enter Mobile" value="<?php echo $userAccount->getMobileNumber();?>" required name="Mobile" id="Mobile" class="form-control" />
										</div>	
										<div class="form-group">
											<label for="LocalAdr1">Profile Image </label><p><?php echo showMessage('adduserError') ;?></p>
											<input type="file" class="uniform-file" name="PhotoPath" id="PhotoPath"/>
										</div>	
									...
									<!-- /.box-header -->
										...
										<div class="box-footer" style="padding-left:220px">
											<input type="submit" class="btn btn-primary"  id="btn-Save" name="btn-Save" value="Update" />
											<input type="button" class="btn btn-primary" onclick="location.href='adduadminser.php'" value="New" />
										</div>							
										</div>
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										...
										<div class="box-body table-responsive">
											<?php include("includes/userslist.php"); ?>
										</div>
										</div>
									</div><!-- /.box-body -->										
								</div>	
