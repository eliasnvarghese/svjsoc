...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(0, .25, "Member Ledger for the period From ".$this->fromDate." to ".$this->toDate,0, 2, "C");
...
if($sumAmount>0){
	$results=$paymentServiceObj->getMemberLedger("DATALIST",$regUId,$fromDate,$toDate,0,999999999999);
...
$pdf->Write(0.1,"\n"); 
//$pdf->Output(); 
$pdf->Output("ledger_".$regUId.".pdf","D");
?>								   