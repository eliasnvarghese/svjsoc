...
if($userAccount==null){
	header("Location:adadminuser.php");
	exit();
}	
?>
<!DOCTYPE html>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
							...
							<!-- /.box-header -->
                                ...
                                <form action="resetpswd_action.php" method="POST" enctype="multipart/form-data">
                                    <div class="box-body"> 
									...
									<p><?php echo showMessage('changePaswdError') ;?></p>
										...
										<input type="text" value="<?php echo $userAccount->getFirstName();?>" name="Name" id="Name" class="form-control" readonly />
