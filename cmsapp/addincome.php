       ...
       <?php include('includes/header.php'); ?>
            ...
            <aside class="right-side">
                ...
                <section class="content">
							...
							<div class="box-body">
								...
								<div class="box-body table-responsive">
                                    ...
                                    <table id="example3" class="table table-bordered table-striped">
                                        <thead>
										<tr>
										<th>RegNo</th><th>Name</th><th>Family Name</th><th>Gender</th><th>City</th><th>Action</th>
										</tr>
                                        </thead>
                                        <tbody>
										<?php
					...
					<!-- /.box -->
                        ...
                        <!-- right column -->
                        <div class="col-md-6">
						<form action="addincome_action.php" method="POST"  role="form" id="ReceiptForm" >
						<div class="box box-primary">
							<!-- /.box-header -->
							 <div class="box-body">
								<div class="form-group row">
									...
									<div class="col-xs-9">
										...
										<select id="Name" class="form-control col-lg-12 col-md-12 col-sm-4 col-xs-12"  onfocus='this.size=10;' onblur='this.size=1;' 
        onchange='this.size=1; this.blur();'>
								...
								<div class="form-group">
									...
									<select class="form-control" id="Category" name="CategoryCode" <?php echo $required;?>>
									...
									<?php													
										...
										while($row=mysqli_fetch_array($results)){
										?>
										<option value="<?php echo $row["incomecode"]; ?>"<?php echo ($categorycode==$row["incomecode"])? "selected" : "";?>	><?php echo $row["description"]; ?> </option>
										<?php
										}
										?>
									</select>
