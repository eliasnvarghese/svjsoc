                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List of Lents</h3>
                                </div><!-- /.box-header -->
								<!-- Search options -->
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										while($row=mysqli_fetch_array($results)){
											$image="uploads/splevents/".$row["eventid"].".jpg";
											if(!file_exists($image))
												$image="images/splevents/holymass.jpg";
										?>
                                            <tr>
                                                ...
                                                <td>
													<a href="editsplevent.php?eventId=<?php echo $row["eventid"]; ?>"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"></i></a>&nbsp;
													<a href="deletesplevent.php?eventId=<?php echo $row["eventid"]; ?>"><i class="fa fa-trash-o" style="color:red" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"></i></a>&nbsp;
												</td>
                                            </tr>
										<?php 	}
											}
									...
									<?php
										$report_filename="listofsplevents.php";
