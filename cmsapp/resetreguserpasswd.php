...
$UserId=$Name=$FamilyName=$Gender=$Dob=$Address=$City=$State=$Mobile=$Phone=$About="";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
							...
							<!-- /.box-header -->
                                ...
                                <form action="resetreguserpasswd_action.php" method="POST" enctype="multipart/form-data">
                                    <div class="box-body"> 
									<div class="form-group">
									<p><?php echo showMessage('changePaswdError') ;?></p>
										<input type="hidden" value="<?php echo $userAccount->getUId();?>" name="UId" id="UId" class="form-control" hidden />
										<input type="text" value="<?php echo $userAccount->getName();?>" name="Name" id="Name" class="form-control" readonly />
									</div>				
									<div class="form-group">
									...
									<div class="form-group">
										<label for="LocalAdr1">Confirm Password </label>
										<input type="password" pattern=".{5,20}" placeholder="Min 5 characters" required name="cnfPswd"  id="cnfPswd"  class="form-control" />
									</div>
								<div class="box ">
							<!-- /.box-header -->
								...
								<div class="box-footer" style="padding-left:220px">
									...
									<input type="button" class="btn btn-primary" onclick="location.href='addreguser.php'" value="New" />
								</div>							
							</div>
						</form>
						</div><!-- /.box-body -->
