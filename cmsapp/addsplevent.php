            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Lent</a></li>
                        <li class="active">Add New Lent</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                      <form onsubmit="return validateform();" action="addsplevent_action.php" role="form" id="eventForm" method="POST" enctype="multipart/form-data" >   
					  <!-- left column -->
                        <div class="col-md-6">
