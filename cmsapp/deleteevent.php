        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="row">
						<form action="deleteevent_action.php" role="form" id="eventForm" method="POST"  >   
						<!-- left column -->
						<div class="col-md-6">
                            ...
                            <div class="box box-info">
								...
								<div class="box-body">
									...
									<div class="form-group ">
										...
										<input type="text" class="form-control" readonly id="EventName" name="EventName" placeholder="Event Name" value="<?php echo $eventObj->getEventName();?>" >
									</div>	
									<div class="form-group ">	
										<label for="Highlights">Highlights </label>
										<input type="text" class="form-control" readonly id="Highlights" name="Highlights" placeholder="Event Highlights" value="<?php echo $eventObj->getHighlights();?>">
									</div>
									<div class="form-group ">
										<label for="Overview">Event Details </label>
										<textarea readonly class="form-control" id="EventDetails" name="EventDetails"  rows="4" placeholder="Event Details"><?php echo $eventObj->getEventDetails();?></textarea>
									</div>	
									<div class="form-group row ">
										<div class="col-xs-6">
											...
											<input class="form-control" value="<?php echo dateDisplayFormat($eventObj->getFromDate(),"m-d-Y");?>" readonly id="FromDate" name="FromDate" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask="" type="text" >
										</div>										
										<div class="col-xs-6">
											<div class="input-group-addon"><label for="ToDate">To Date </label>
												<i class="fa fa-calendar"></i>
											</div>
											<input class="form-control" value="<?php echo dateDisplayFormat($eventObj->getToDate(),"m-d-Y");?>" readonly id="ToDate" name="ToDate" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask="" type="text" >
										</div>
									</div>
								</div><!-- /.box-body -->
							</div>
									...
									<div class="form-group row">
										<div class="col-xs-12">
											...
											if(!file_exists($imageUrl)){
												$imageUrl= "images/events/holymass.jpg";
											}
											?>
											<img id="coverimage" src="<?php echo $imageUrl; ?>" alt=""  width="50%;" />
										</div>
									</div>	
								</div><!-- /.box-body -->
							</div>
