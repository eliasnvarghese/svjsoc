                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
							...
							<!-- /.box-header -->
                                ...
                                <form action="addadminuser_action.php" method="POST" enctype="multipart/form-data">
                                    <div class="box-body">   
										...
										<div class="form-group">
											<label for="LocalAdr1">Place </label>
											<input type="text"  placeholder="Enter Place" required name="Place" id="Place" class="form-control" />
										</div>	
										<div class="form-group">
										...
										<div class="box ">
											...
											<div class="box-footer" style="padding-left:240px">
												<input type="submit" class="btn btn-primary"  id="btn-Save" name="btn-Save" value="Add" />
											</div>							
										</div>
									</div><!-- /.box-body -->
								</form>
