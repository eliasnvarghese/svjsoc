	...
	<div class="form-group row">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody >
                                            <?php
												...
												$results=$userService->getUserActivityByPeriod($fromDate,$toDate);
												...
												?>
												<tr>
													<td><img src="<?php echo $photopath; ?>" width="28" height="28" /><br><?php echo trim($row["userid"]); ?></td>
        ...
        <script type="text/javascript">
			...
			$('#saveAs').click(function(e){
				...
				if(url!=""){
					var openurl="useractivities_pdf.php?"+url;
