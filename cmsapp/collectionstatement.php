                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$RESULTDATACOUNT=$paymentServiceObj->getReceiptListForPeriod("DATACOUNT",$fromDate,$toDate);
										if($RESULTDATACOUNT>0){
											$sumAmount=$paymentServiceObj->getReceiptListForPeriod("SUMRECT",$fromDate,$toDate);										
											$results=$paymentServiceObj->getReceiptListForPeriod("DATALIST",$fromDate,$toDate,$rowNo,$NOOFLINES);
								...
								<div class="box-footer">  
									<button type="submit" id="downloadStmt" name="<?php echo "fromDate=".$fromDate."&toDate=".$toDate; ?>" value="saveas" data-dismiss="modal" class="btn btn-primary" >
  ...
  <script type="text/javascript">
            $(function() {
				$('#downloadStmt').click(function(e){
					...
					if(url!=""){
						var openurl="collectionstatement_pdf.php?"+url;
