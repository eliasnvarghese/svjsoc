...
<title>Photos of St. Stephen's Jacobite Syriac Orthodox Church, San Jose, California</title>
	...
	<div class="block remove-gap">
		<div class="container">
			<div class="row">
				<div class="title2">
					<span></span>
					<h2>OUR <span>PHOTO GALLERY</span></h2>
				</div>
					...
					<div class="remove-ext">
						<div class="row">
							<div class="mas-gallery">
								...
								$log->debugLog("Page No = ".$pageno);
								$rowNo=$pageno*$NOOFLINES-($NOOFLINES);
								$log->debugLog("Page No = ".$pageno." Rowno = ".$rowNo);
								$searchString ="";
								$postingServiceObj=new PostingService();
								$RESULTDATACOUNT=$postingServiceObj->getAllPostings('DATACOUNT',"Image");
								if($RESULTDATACOUNT>0){
									$i=0;
									$results=$postingServiceObj->getAllPostings('DATALIST',"Image",$rowNo,$NOOFLINES);
									while($row=mysqli_fetch_array($results)){
										
										?>						
										<div class="col-md-4">
											<div class="gallery lightbox">
												<img src="cmsapp/uploads/gallery/<?php echo $row["imagepath"];?>" alt="" /> 
												<ul style="margin-top:-10px;top:1%;">
													<li ><a  href="cmsapp/uploads/gallery/<?php echo $row["imagepath"];?>" title="">
													<img src="images/resource/gallery/transmask.png" width="100%" alt="" /></a></li>
												</ul>
